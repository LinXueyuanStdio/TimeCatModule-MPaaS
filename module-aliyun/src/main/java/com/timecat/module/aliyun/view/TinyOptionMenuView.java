package com.timecat.module.aliyun.view;
...
import com.timecat.module.aliyun.R;
...
public class TinyOptionMenuView extends AbsTinyOptionMenuView {
    ...
    public void onStateChanged(TinyAppActionState state) {
        if (state == null) {
            ivMore.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_more_horiz_black_24dp));
        } else if (state.getAction().equals(TinyAppActionState.ACTION_LOCATION)) {
            ivMore.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_location));
        }
    }
